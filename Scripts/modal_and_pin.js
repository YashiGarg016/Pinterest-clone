const add_pin_modal = document.querySelector('.addPinModal');
        ...
        if (/image\/*/.test(event.target.files[0].type)) {
            ...
            reader.onload = function () {
                ...
                new_image.onload = function () {
                    const modals_pin = document.querySelector('.addPinModal .modalsPins');

                    new_image.classList.add('pin_max_width');

                    document.querySelector('.addPinModal .pinImage').appendChild(new_image);
...
function create_pin(pin_details) {
    ...
    new_image.onload = function () {
        ...
        new_pin.innerHTML = `<div class="pinTitle">${pin_details.title}</div>
        ...
        <div class="pinModal"> 
           ...
           <div class="modalFoot">
            <div class="destination">
                <div class="pintMock">
                    <img src="./images/upper-right-arrow.png" alt="destination" class="pintMock">
                </div>
                <span>${pin_details.destination}</span>
            </div>
            
                <div class="pintMock">
                   <img src="./images/send.png" alt="send" class="pintMock_icon">
                 </div> 
                
                 <div class="pintMock">
                    <img src="./images/ellipsis.png" alt="" class="pintMock_icon">
                </div>
             </div> 
        ...
        document.querySelector('.pinCont').appendChild(new_pin);
